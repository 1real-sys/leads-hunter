...
Os refinamentos de filiais, nomes comerciais alternativos, telefone/endereço parcial e handle de ramo estão implementados e testados; Petz Vila Velha, Supermercado Michel, Hortifruti Castelo e Multishow Castelo foram confirmados com a API real nos respectivos escopos. O aceite amplo da **INFO-01.7** permanece parcial: falta uma amostra rotulada maior de URLs realmente pertencentes aos estabelecimentos para medir precisão/cobertura. Uma nova execução de `Buscar informações` reavalia ausências e resultados parciais; blocos com os dois links válidos continuam sendo ignorados. Capturas antigas por nome/handle não devem ser tratadas como identidade comprovada; não houve correção retroativa dos blocos já gravados. O scraping permanece desativado. Falhas técnicas não produzem ausência conclusiva nem alteram observações; candidatos sem confirmação são recusados.
