...
Este documento descreve o fluxo real do projeto no estado atual. O backend está concluído e os sprints FE-00 a FE-11 do frontend foram entregues; o próximo passo do MVP é listar as buscas anteriores.
...
Os sprints **FE-00** a **FE-11** estão concluídos e validados. O próximo passo é executar o **FE-12 — Lista do histórico de buscas**; os demais sprints permanecem pendentes.
