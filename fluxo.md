...
Este documento descreve o fluxo real do projeto no estado atual. O backend está concluído e os sprints FE-00 a FE-14 do frontend foram entregues; o próximo passo é adaptar o shell para o workspace operacional definitivo.
