...
Os sprints **FE-00** a **FE-17**, a melhoria **FE-100**, a manutenção do WhatsApp, **IDHM-00** a **IDHM-05**, **BL-00** a **BL-04**, **CNPJ-00** a **CNPJ-07**, **CNPJMATCH-00** a **CNPJMATCH-03** e **DM-01** estão implementados nos respectivos escopos. Não há outra etapa de dark mode pendente. A promoção do refinamento CNPJ permanece deliberadamente pendente da revisão manual exigida pelo próprio plano; o flag de produção continua fail-closed e nenhum `--aplicar` foi executado.
