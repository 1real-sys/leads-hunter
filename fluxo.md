...
Este documento descreve o fluxo real do projeto no estado atual. O backend está concluído e os sprints FE-00 a FE-10 do frontend foram entregues; o próximo passo do MVP é editar observações e registrar o último contato manual.
