...
Este documento descreve o fluxo real do projeto no estado atual. O backend está concluído e os sprints FE-00 a FE-14 e FE-15A do frontend foram entregues; o próximo passo é adaptar Kanban e Histórico ao workspace operacional criado na FE-15A.
...
| FE-15B | Adaptação das áreas ao workspace operacional | PENDENTE |
...
Os sprints **FE-00** a **FE-14** e **FE-15A** estão concluídos e validados. O próximo passo é executar o **FE-15B — Adaptação das áreas ao workspace operacional**, preservando o shell criado na FE-15A; os demais sprints permanecem pendentes.
