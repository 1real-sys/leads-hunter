-- Gerado no formato de tools/cnpj/gerar_dataset.py; base publica RFB 2026-08.
-- Recorte inicial minimo para validar Vitoria/ES, Vila Velha/ES e Curitiba/PR.

DELETE FROM cnpj_estabelecimento
WHERE municipio_codigo_ibge IN ('3205200', '3205309', '4106902');
...
INSERT INTO cnpj_empresa (
    ...
    ('23502037', 'CB CURITIBA COMERCIO DE ALIMENTOS LTDA', 'cb curitiba comercio de alimentos ltda', '2026-08-08'),
    ('23681920', 'CB VILA VELHA COMERCIO DE ALIMENTOS LTDA', 'cb vila velha comercio de alimentos ltda', '2026-08-08'),
    ('43869215', 'CB VITORIA COMERCIO DE ALIMENTOS LTDA', 'cb vitoria comercio de alimentos ltda', '2026-08-08')
...
INSERT INTO cnpj_estabelecimento (
    ...
    (
        ...
        'BATEL', 'batel', '80420063', '4106902', 'PR', '02', '2026-08-08'
    ),
    (
